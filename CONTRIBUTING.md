...
- **Explain fixture/golden updates**: if you update any JSON under `tests/fcode/`, include a short note in the PR describing why the expected output changed.
...
- **Default behavior**: if you change `fortran_parser/` or `tests/fcode/`, update `parser_implementation_reference.md` when the change affects the documented feature inventory or behavior.
