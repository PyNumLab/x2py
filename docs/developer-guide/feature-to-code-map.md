...
| Semantic `.pyi` conversion and editing | `docs/user-guide/editing-semantic-pyi-contracts.md`, `docs/reference/semantic-pyi-format.md`, `docs/examples-gallery/recipes/semantic-pyi-contracts.md`, `docs/roadmap/semantic-pyi-wrapper-checklist.md` | `x2py/pyi_parser/parser.py`, `x2py/pyi_pipeline.py`, `x2py/semantics/pyi2ir.py`, `models.py` | `tests/pyi/test_pyi_to_ir.py`, `tests/pyi/test_pyi_fixture_suite.py` | Edited contracts parse to Python AST, then become semantic IR with preserved native facts |
