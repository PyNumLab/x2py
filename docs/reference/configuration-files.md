...
related: cli-commands.md, python-api.md, ../user-guide/packaging.md, ../developer-guide/quality-assurance.md
status: maintained
---
...
The repository `pyproject.toml` is maintainer-facing configuration. It defines
...
[Quality Assurance](../developer-guide/quality-assurance.md#pytest-and-coveragepy).
