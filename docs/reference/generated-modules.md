...
related: generated-functions.md, generated-classes.md, semantic-pyi-format.md, ../user-guide/wrapping-modules.md
status: maintained
---
...
Use [Wrapping Modules](../user-guide/wrapping-modules.md) for a source-first
...
ownership rules in [Memory Management](../user-guide/memory-management.md) and
the topic-specific user-guide pages. Missing addressability, ownership,
release, or mutability facts block generation.
