...
related: generated-functions.md, generated-modules.md, semantic-pyi-format.md, ../user-guide/wrapping-derived-types.md, ../user-guide/memory-management.md
status: maintained
---
...
Use [Wrapping Derived Types](../user-guide/wrapping-derived-types.md) for the
source-first workflow and [Memory Management](../user-guide/memory-management.md)
