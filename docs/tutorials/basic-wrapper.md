...
related: ../getting-started/index.md, ../examples-gallery/verified-cookbook.md
status: maintained
---
...
- `n` is a read-only integer reference.
...
- Use the [verified examples cookbook](../examples-gallery/verified-cookbook.md)
  for task-specific recipes.
- Use the [Fortran wrapper guide](../user-guide/fortran-wrapper.md) for the
