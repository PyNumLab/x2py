...
ownership metadata. Use [Memory Management](memory-management.md) and the
[semantic `.pyi` ownership reference](../reference/semantic-pyi-format.md#ownership-transfer-and-destruction-policies)
to determine whether snapshot behavior is expressible.
