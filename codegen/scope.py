...
from .models.bind_c import BindCVariable
from .models.core import ClassDef, FunctionDef
from .models.core import PyccelFunction, PyccelSymbol
...
class Scope:
    ...
    def insert_symbol(self, symbol, object_type="variable"):
        ...
        if type(symbol).__name__ == "AnnotatedPyccelSymbol":
            symbol = symbol.name
