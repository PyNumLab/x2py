...
from ..models.builtins import PythonRange
...
from ..models.numpyext import NumpyInt32
from ..models.datatypes import NumpyInt32Type, NumpyNDArrayType, numpy_precision_map
from ..models.operators import PyccelAdd, PyccelIsNot, PyccelMul
    ...
    def _visit_FunctionDef(self, expr):
        ...
        if in_cls and interface:
            body = self._get_function_def_body(
                interface[0], generated_args, func_call_results
            )
        else:
