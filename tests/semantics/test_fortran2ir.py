...
def test_intrinsic_builtin_kinds_map_to_semantic_types():
    ...
    cases = [
        ...
        (FortranVariable(name="cflag", base_type="logical", kind="c_bool"), "Bool"),
        ...
        (FortranVariable(name="single", base_type="real", kind="kind(1.0e0)"), "Float32"),
        (FortranVariable(name="double", base_type="real", kind="kind(1.0d0)"), "Float64"),
        (FortranVariable(name="quad", base_type="real", kind="kind(1.0q0)"), "Float128"),
    ]
