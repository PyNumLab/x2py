from x2py.contracts import Aliased, Allocatable, Annotated, Float64, Pointer, PointerAssociation, PointerPolicy, Polymorphic, bind
...
def box_associate_values(self: Annotated[pointer_box, Polymorphic]) -> None: ...
def box_associate_values_strided(self: Annotated[pointer_box, Polymorphic]) -> None: ...
