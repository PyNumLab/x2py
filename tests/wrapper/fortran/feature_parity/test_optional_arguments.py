...
OPTIONAL_F90_TEXT = wrapper_source("foptional_f90.f90").read_text(encoding="utf-8")
OPTIONAL_FIXED_TEXT = wrapper_source("foptional_fixed.f").read_text(encoding="utf-8")
