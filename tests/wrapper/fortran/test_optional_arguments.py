...
OPTIONAL_F90_TEXT = Path(__file__).with_name("foptional_f90.f90").read_text(encoding="utf-8")
OPTIONAL_FIXED_TEXT = Path(__file__).with_name("foptional_fixed.f").read_text(encoding="utf-8")
