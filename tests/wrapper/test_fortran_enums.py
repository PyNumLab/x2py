...
from tests.wrapper._support import _build_and_import


ENUM_SOURCE = Path(__file__).with_name("fenums_f90.f90")


def test_fortran_enums_preserve_values_pyi_contract_and_integer_runtime_surface(tmp_path: Path):
